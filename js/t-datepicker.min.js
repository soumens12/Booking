...
if(pr_in!==null){label_title='Check In';}
if(e==='check-out'){label_title=settings.titleCheckOut;getDay=pr_out;if(pr_in===pr_out){getDay=null;}else if(pr_out!==null){label_title='Check Out';}
Input='t-end'}
